...
//                 <h4 className="text-center py-4 dark:text-gray-400">
//                       You haven't applied for any jobs yet.
//                 </h4>
//             ):(
//                 allAppliedJobs.map((appliedJob)=>(
//                     <div key={appliedJob._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
//                         <h2><b>Job role:</b> {appliedJob.job?.title}</h2>
//                         <h2><b>Company:</b> {appliedJob.job?.company?.name}</h2>
//                         <h2><b>Date:</b> {appliedJob?.createdAt?.split("T")[0]}</h2>
//                         <h2><b>Status:</b> <Badge
                ...
                allAppliedJobs.map((appliedJob) => (
                    ...
                    >
                        <h2 className="text-md font-semibold text-gray-900 dark:text-white">
                            <b>Job Role:</b> {appliedJob.job ? appliedJob.job?.title : "Hiring closed"}
                        </h2>
