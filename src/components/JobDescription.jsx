  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto my-10 px-6 py-8 bg-white shadow-lg rounded-xl border border-gray-200">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            ...
            <div className="flex flex-wrap gap-3 mt-3">
              ...
              <Badge className="text-[#F83002] font-bold bg-red-100 px-3 py-1 rounded-md">
                {singleJob?.jobType || "Full-Time"}
              </Badge>
              <Badge className="text-[#7209b7] font-bold bg-purple-100 px-3 py-1 rounded-md">
          ...
          <Button
            ...
            className={`rounded-lg px-6 py-2 transition-all text-white shadow-md ${
              isApplied
                ...
                : "bg-[#7209b7] hover:bg-[#5f32ad] hover:shadow-lg"
            }`}
          >
        ...
        <div className="mt-8">
          <h1 className="border-b-2 border-gray-300 font-semibold py-4 text-xl text-gray-800">
            Job Description
          </h1>
