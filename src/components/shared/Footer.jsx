...
//             <p className="text-sm">© 2025 JobBridge Company. All rights reserved.</p>
//           </div>
...
const Footer = () => {
  return (
    <footer className="border-t border-gray-200 py-8 ">
      <div className="container mx-auto px-4 flex flex-col items-center text-center md:flex-row md:justify-between md:text-left">
        {/* Company Name & Copyright */}
        <div className="mb-4 md:mb-0">
          <h2 className="text-xl font-bold">Job Bridge</h2>
          <p className="text-sm text-gray-500">© 2025 JobBridge Company. All rights reserved.</p>
        </div>

        {/* Social Icons */}
        <div className="flex space-x-4">
          <span className="hover:text-gray-400 cursor-pointer" aria-label="Facebook">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M22.676 0H1.324C.593 0 0 .592 0 1.324v21.352C0 23.408.593 24 1.324 24H12.82V14.706H9.692v-3.578h3.128V8.408c0-3.1 1.893-4.787 4.657-4.787 1.325 0 2.463.1 2.794.144v3.238l-1.918.001c-1.503 0-1.794.715-1.794 1.762v2.31h3.587l-.468 3.578h-3.119V24h6.116C23.407 24 24 23.408 24 22.676V1.324C24 .592 23.407 0 22.676 0z" />
            </svg>
          </span>

          <span className="hover:text-gray-400 cursor-pointer" aria-label="Twitter">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
