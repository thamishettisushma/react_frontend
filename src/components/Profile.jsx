...
//                     <Label className="text-md font-bold">Resume</Label>
//                     {isResume ? (
//                         <a target='_blank' rel="noopener noreferrer" href={user?.profile?.resume} className='text-blue-500 hover:underline cursor-pointer break-all text-sm sm:text-base'>
...
//             <div className='max-w-4xl mx-auto bg-white rounded-2xl p-4 sm:p-6 md:p-8'>
...
const Profile = () => {
    ...
    return (
        ...
        //     <Navbar />
        //     <div className='max-w-4xl mx-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl my-5 p-4 sm:p-6 md:p-8'>
        //         {/* Profile Header */}
        //         <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
        //             <div className='flex flex-col sm:flex-row items-center gap-4 w-full'>
        //                 <Avatar className="h-20 w-20 sm:h-24 sm:w-24">
        ...
        //                 <div className="text-center sm:text-left w-full">
        //                     <h1 className='font-medium text-lg sm:text-xl'>{user?.fullname}</h1>
        //                     <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base">{user?.profile?.bio}</p>
        //                 </div>
        //             </div>
        //             <Button onClick={() => setOpen(true)} className="shrink-0" variant="outline" >
        //                 <Pen className="h-5 w-5" />
        ...
        //                 {user?.profile?.skills.length ? (
        //                     user?.profile?.skills.map((item, index) => (
        //                         <Badge key={index} className="text-black text-xs sm:text-sm bg-gray-200 dark:bg-gray-700 dark:text-gray-300">
        //                             {item}
        //                         </Badge>
        //                     ))
        //                 ) : (
        ...
        //             <Label className="text-md font-bold dark:text-white mr-5">Resume</Label>
        //             {isResume ? (
        //                 <a target='_blank' rel="noopener noreferrer" href={user?.profile?.resume} className='text-blue-500 dark:text-blue-400 hover:underline cursor-pointer break-all text-sm sm:text-base'>
        //                     {user?.profile?.resumeOriginalName}
        //                 </a>
        //             ) : (
        //                 <span className="text-gray-500 dark:text-gray-400">NA</span>
        ...
        //     {/* Applied Jobs Section */}
        //     <div className='max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 md:p-8'>
        //         <h1 className='font-bold text-lg sm:text-xl my-5 dark:text-white'>Applied Jobs</h1>
